...
namespace Raw.Socket
{
    public class Ipv6Header : ProtocolHeader
    {
        ...
        {
            get { return ipTrafficClass; }
            set { ipTrafficClass = value; }
        }
        ...
        {
            get { return ipNextHeader; }
            set { ipNextHeader = value; }
        }
        ...
        {
            get { return ipHopLimit; }
            set { ipHopLimit = value; }
        }
        ...
        {
            get { return ipDestinationAddress; }
            set { ipDestinationAddress = value; }
        }
        ...
        public override byte[] GetProtocolPacketBytes(byte[] payLoad)
        {
            ...
            ipv6Packet[offset++] = (byte) ((uint) ((ipTrafficClass << 4) & 0xF0) | (Flow >> 16) & 0xF);
            ...
            ipv6Packet[offset++] = ipNextHeader;
            ipv6Packet[offset++] = ipHopLimit;
